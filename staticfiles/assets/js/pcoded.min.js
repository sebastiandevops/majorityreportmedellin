...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://majorityreportmedellin.herokuapp.com/medellincharts/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> Más gráficas' +
    '</a> ' + '</div>' + '');
var $window = $(window);
